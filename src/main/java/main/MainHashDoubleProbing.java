...
import models.HashDoubleProbing;
 ...
 *
 * Remarques : Main class for HashDoubleProbing
 */
public class MainHashDoubleProbing {

    public static void main(String[] args) throws KeyDoesNotExistException {
        HashDoubleProbing map = new HashDoubleProbing(Constant.M);
        map.put('B', 0);
        map.put('N', 7);
        map.put('X', 6);
