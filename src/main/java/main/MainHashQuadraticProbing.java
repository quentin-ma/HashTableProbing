...
import models.HashQuadraticProbing;
 ...
 *
 * Remarques : Main class for HashQuadraticProbing
 */
public class MainHashQuadraticProbing {

    public static void main(String[] args) throws KeyDoesNotExistException {
        HashQuadraticProbing map = new HashQuadraticProbing(Constant.M);
        map.put('B', 0);
        map.put('N', 7);
        map.put('X', 6);
